...
BRANCHES: list[dict] = [
    ...
    # ---------------------------- COLONNE DROITE --------------------------- #
    {
        ...
        "children": [
            ...
            ("output_manager.py", "QTimer dans le métier · archive_files supprime sans vérifier le zip", "err"),
    ...
    },
    {
        ...
        "children": [
            ...
            ("export_engine.py", "PDF/X-1a & X-4, TIFF, JPEG · OutputIntent FOGRA39 en dur", "warn"),
